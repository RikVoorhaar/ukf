...
pub struct UnscentedKalmanFilter {
    ...
    pub Q: Array2<Float>,
    pub R: Array2<Float>,
    sigma_points: Box<dyn SigmaPoints>,
    pub dim_x: usize,
    pub dim_z: usize,
    hx: fn(ArrayView1<Float>) -> Array1<Float>,
    fx: fn(ArrayView1<Float>, Float) -> Array1<Float>,
...
impl UnscentedKalmanFilter {
    ...
    fn compute_process_sigmas(&mut self, dt: Float) -> Result<(), Box<dyn Error>> {
        ...
        sigmas.outer_iter().zip(self.sigmas_f.rows_mut()).for_each(
            |(row_sigmas, mut row_sigmas_f)| {
                row_sigmas_f.assign(&(self.fx)(row_sigmas, dt))
            },
        );
    ...
    pub fn update(&mut self, z: Array1<Float>) {
